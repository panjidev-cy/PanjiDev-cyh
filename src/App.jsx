  ...
  return (
    <div>
      <header className="flex items-center justify-between gap-5 p-3 fixed top-0 left-0 right-0 z-[999] bg-slate-200 ">
        ...
        <div>
          <button className="bg-primary-600 text-primary-100 font-Playwrite text-sm px-3 py-1 rounded-lg">Get Started</button>
        </div>
      ...
      <main>
        ...
        <section className='w-full p-10 flex flex-col items-center mt-24'>
          ...
          <section className='w-full  mt-10 py-5'>
              <CardTimeline>
                <h2 className='font-Manrope font-bold text-2xl text-gray-400'>Asus Laptop</h2>
